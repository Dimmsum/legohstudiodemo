...
export default function Dashboard() {
  ...
  return (
    <section className="pt-16 pb-28 bg-white text-black min-h-screen flex flex-col font-serif relative">
      {/* Background */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url('/dance-studio.jpg')`, zIndex: 0, height:"100vh", }}
      />

      {/* Contact Modal */}
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-4">
          <div className="bg-white rounded-2xl p-6 sm:p-8 max-w-md sm:max-w-lg w-full shadow-2xl relative">
            <button
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex-grow relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-1 gap-12 items-center text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 font-light italic leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-gradient-to-br from-rose-100 to-rose-200 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-rose-700 mb-4">
                From classical foundations to contemporary styles. Individual and group lessons available.
              </p>
            ...
            <div className="bg-gradient-to-br from-rose-100 to-rose-200 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-rose-700 mb-4">
                Combine singing, dancing, and acting in our comprehensive musical theater program.
              </p>
              <div className="text-sm text-rose-600">
            ...
            <div className="bg-gradient-to-br from-rose-100 to-rose-200 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-rose-700 mb-4">
                Develop your unique voice with professional vocal coaching and performance techniques.
              </p>
              <div className="text-sm text-rose-600">
        ...
        <div className="mt-20 bg-gray-50 rounded-3xl p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Emily Hall</h3>
              <p className="text-rose-600 font-semibold mb-2">Studio Director</p>
              <p className="text-gray-600 text-sm">
                15+ years in performing arts education with a Master's in Music Performance.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Marcus Johnson</h3>
              <p className="text-rose-600 font-semibold mb-2">Voice & Piano Instructor</p>
              <p className="text-gray-600 text-sm">
                Broadway veteran with performances in major productions across the country.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Sarah Liu</h3>
              <p className="text-rose-600 font-semibold mb-2">Dance & Movement</p>
              <p className="text-gray-600 text-sm">
                Former principal dancer with extensive choreography and teaching experience.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="text-center py-8 text-sm text-gray-600">
        <div className="flex flex-wrap justify-center items-center gap-4 mb-2">
          <a
            href="https://www.instagram.com/legohstudio/"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/legohstudio/"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-rose-600"
          >
